...
keyboard.keymap = [
    [
        KC.LGUI(KC.N1), KC.LGUI(KC.N2), KC.LGUI(KC.N3),  KC.LGUI(KC.N4), KC.LGUI(KC.N5),  KC.LGUI(KC.MINUS), KC.MO(1), KC.AUDIO_VOL_UP,   
        KC.LALT(KC.N1), KC.LALT(KC.N2),  KC.LALT(KC.N3), KC.LALT(KC.N4), KC.LALT(KC.N5), KC.LALT(KC.N9), KC.UP, KC.AUDIO_VOL_DOWN,   
        KC.LSFT(KC.RCTL(KC.TAB)), KC.RCTL(KC.TAB), KC.RCTL(KC.F5),    KC.F,    KC.J,    KC.LEFT,    KC.ENTER,  KC.RIGHT,
        KC.RCTL(KC.F5), KC.L, KC.F, KC.DOT, KC.N0, KC.N9, KC.DOWN, KC.SPACE,  
    ],
    [
